# VGG16 model based on the dog-or-cat database: https://www.kaggle.com/competitions/dogs-vs-cats/data?select=sampleSubmission.csv
...
# dist_validation_dataset = strategy.experimental_distribute_dataset(validation_dataset)
...
with strategy.scope():
    ...
    model = keras.Model(inputs=inputs, outputs=outputs, name="VGG16_Mirror_model")
    model.compile(loss='binary_crossentropy', optimizer=opt,metrics=['accuracy'])

print(model.summary())
vgg16_mirror_name = model.name
...
fname = 'cat-or-dog-' + vgg16_mirror_name + '-reuse.h5'
