...
model = keras.Model(inputs=inputs, outputs=outputs, name="VGG16_model")
...
# log messages
logdir = os.path.join(os.getcwd(), "logs", "cats-or-dogs"+vgg16_name+"-reuse-"+
...
fname = 'cat-or-dog-' + vgg16_name + '-reuse.h5'
